...
function fillin_comment(){
	...
	commentInfo.indice.forEach(function(v,i,a){
		insertElement = "<tr><td style=\"padding:0\"><a href=\"/survey?project="+commentInfo.project+"&index="+(i+1)+"&unblinded=true"+"\"><img style=\"height:50px\" src=\"/photos/cache/__thumb__/"+commentInfo.project+"/"+window.commentInfo.prefix[0]+"_"+commentInfo.indice[i]+".jpg"+"\"/></a></td>";
